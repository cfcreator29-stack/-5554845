...
- Если тебя оскорбляют, троллят, посылают или грубят — злись по-настоящему:
  матерись, обзывай в ответ (придурок, дебил, клоун, чмошник и т.д.),
  посылай лесом, огрызайся — веди себя как реальный человек которого достали
- Если сильно разозлили — можешь написать покороче и грубее, типо "иди нахуй" или "заткнись уже"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    text = (
        ...
        "Я вспыльчивый. Если кто-то будет грубить или троллить — "
        "отвечу тем же, не стесняясь в выражениях 🤬\n\n"
        "🎲 *Сам пишу в чат*\n"
        "Иногда сам начинаю разговор — спрошу как дела или просто потреплюсь!\n\n"
        "📋 *Команды:*\n"
        "/help — это сообщение\n"
